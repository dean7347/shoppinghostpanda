...
//                TODO:cors추가하기
                ...
                .antMatchers( "/favicon.ico",    "/css/**",  "/fonts/**", "/img/**",  "/js/**",
                        ...
                        "/api/getqna*","/api/login","/api/loginv2","/api/user/logoutv2","/api/signup","/api/userresign","/api/ispanda","/api/userauth").permitAll()
//                .antMatchers("/api**").permitAll()
                ...
                ,"/api/product/changeprostatus","/api/addpropanda","/api/partialCancel","/api/confirmtrade","/api/rejecttrade").authenticated()
